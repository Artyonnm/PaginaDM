  ...
  <header id="header">
    <div class="container">
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a class="menu-active" href="index.php">Vídeos</a></li>
          <li><a target="_blank" href="agregarVideo.php">Editar Contenido</a></li>
...
<div class="hero" style="position: relative;">
  ...
  <h1 id="posicionarelementocentrado">
    Ven a 
      <a style="font-weight: 600; color: #ce3635 !important;" href="" class="typewrite" data-period="2000" data-type='[ " Jugar!", " Divertirte!", " Crecer!"]'>
